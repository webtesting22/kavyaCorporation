...
const HeroSection = () => {
  ...
  const Para =
    "At Kavya Corporation, we are committed to safeguarding lives and properties through reliable fire safety solutions. We provide a wide range of high-quality fire equipment, including extinguishers, alarms, hydrants, and protective systems, tailored to meet diverse safety needs. Alongside our products, our expert services—from installation and maintenance to compliance support—ensure that your premises remain fully prepared and protected. With a focus on trust, innovation, and safety, we deliver solutions you can rely on when it matters most.";
  ...
  return (
    <>
      <div
        ...
        className="SectionBackSecondory flexCenter"
      >
            ...
            <Col lg={12} md={24}>
              <div className="fireImageHeroSection">
                <Skeleton loading={loading} active paragraph={{ rows: 2 }}>
                  <div>
                    <img
                      src="/Images/HeroSection/HeroSectionGraphic.png"
                      alt=""
                    />
                  </div>
                </Skeleton>
