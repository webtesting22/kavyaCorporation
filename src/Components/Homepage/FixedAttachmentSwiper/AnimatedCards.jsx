        ...
        <section className="fire-process-section">
            ...
            <div className="background-elements">
                <svg className="bg-svg-1" viewBox="0 0 100 100" fill="none">
                    <circle cx="50" cy="50" r="40" stroke="rgba(230, 59, 59, 0.1)" strokeWidth="2" fill="none">
                ...
                <svg className="bg-svg-2" viewBox="0 0 100 100" fill="none">
                    <rect x="20" y="20" width="60" height="60" stroke="rgba(255, 107, 107, 0.1)" strokeWidth="2" fill="none">
                        <animate attributeName="width" values="60;70;60" dur="4s" repeatCount="indefinite"/>
            ...
            <div className="MainContainer paddingTop paddingBottom">
                ...
                <div className="section-header textCenter ">
                    ...
                    <p className="section-subtitle">
                        Comprehensive fire safety solutions from initial planning to complete system implementation. 
                        We ensure NBC compliance, facilitate approvals, and deliver end-to-end protection.
                    </p>
                </div>
                ...
                <div className="process-grid container">
                    {cardData.map((card, index) => (
                        <div 
                            key={index} 
                            className={`process-card ${card.isHighlighted ? 'highlighted' : ''} fadeInUp`}
